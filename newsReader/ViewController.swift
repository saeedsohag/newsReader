...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func fetchArticles( fromSource provider:String){
        let urlRequest = URLRequest(url: URL(string: "https://newsapi.org/v1/articles?source=bbc-news&sortBy=top&apiKey=f0569a4a3d074d3a89b0e70d570f86e2")!)
    ...
    let manuManager = MenuManager()
    @IBAction func menuPressed(_ sender: Any) {
        manuManager.openmenu()
        manuManager.mainVC = self
    }
}
